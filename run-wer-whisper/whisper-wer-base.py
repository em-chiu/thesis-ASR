...
refs = glob.glob('/Users/emily/Desktop/cd-reference-txt/reference-base/*.txt')
...
file_name = [os.path.basename(x) for x in glob.glob('/Users/emily/Desktop/whisper-output-base/*.txt')]
...
print(f"Raw Data WER: {unnormalized_wer * 100:.2f}%") #44.61%
...
print(f"Normalized & Lowered Data WER: {cleaned_wer * 100:.2f}%") #19.64%
...
print(f"Tokenized Data WER: {token_wer * 100:.2f}%") #19.69%

# Raw Data WER: 44.61%
# Normalized & Lowered Data WER: 19.64%
# Tokenized Data WER: 19.69%